 ...
 * alternative is via the {@link com.google.samples.apps.iosched.ui.widget.SlidingTabLayout.TabColorizer} interface which provides you
...
public class SlidingTabLayout extends HorizontalScrollView {
  ...
  /**
   * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link com.google.samples.apps.iosched.ui.widget.SlidingTabLayout}
   * you are
  ...
  public void setOnPopulateTabStripListener(
      OnPopulateTabStripListener onPopulateTabStripListener) {
  ...
  private void populateTabStrip() {
    ...
    for (int i = 0; i < adapter.getCount(); i++) {
      ...
      if (mOnPopulateTabStripListener != null) {
        tabView = mOnPopulateTabStripListener.onPopulateTabStrip(i, mTabStrip);
      } else {
  ...
  public interface OnPopulateTabStripListener {

    View onPopulateTabStrip(int position, ViewGroup parent);
  }
